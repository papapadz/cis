      ...
      <div id="divcontent" style="font-size:10px; background-color: #f8f7f7; border-radius:2px; padding: 20px; border:1px solid #ccc; margin-bottom: 20px;  " >
        ...
        <div class="col-md-10" style=" background-color: #fff; border:1px solid #ccc; padding: 10px; " >
          @if(Session::has('empname'))
            <h4 style="margin:0;" >Add Work Experience - <span style="color:green;" >[ {{Session::get('empname')}} ]</span></h4>
          @endif
          ...
          <hr style="margin:0px 0px 5px 0px; " />
              ...
              {!! Form::open(array( 'action' => 'AdminController@addworkexp' ,'enctype' => 'application/x-www-form-urlencoded')) !!}
              <table id="tbl_adddep" style="width:100%; position:relative; " border="1" >
                <tr>
                    <td width="15%" align="right" >Position</td>
                    <td>
                    {!! Form::text('position','',array('id'=>'position', 'style'=>'width:100%')) !!}
                    </td>
                </tr>
                <tr>
                    <td align="right" >Status</td>
                    <td>
                    {!! Form::text('status','',array('id'=>'status', 'style'=>'width:100%')) !!}
                    </td>
                </tr>
                <tr>
                    <td align="right" >Company</td>
                    <td>
                    {!! Form::text('company','',array('id'=>'company', 'style'=>'width:100%')) !!}
                    </td>
                </tr>
                <tr>
                    <td align="right" >Address</td>
                    <td>
                      {!! Form::text('address','',array('id'=>'address', 'style'=>'width:100%')) !!}
                    </td>
                </tr> 
                <tr>
                    <td align="right" >Salary</td>
                    <td>
                      {!! Form::number('salary','',array('id'=>'salary', 'style'=>'width:100%')) !!}
                    </td>
                </tr>                
                <tr>
                ...
                <tr>
                    ...
                    <td>
                      {!! Form::select('isgov', array('Y' => 'Yes', 'N' => 'No'), null,array('style'=>'padding:2px; width:100%;')) !!}
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
